...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(8, 24, 485, 353))
        ...
        self.bolillaInput = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.bolillaInput.setStyleSheet("font-size: 13px;")
        self.bolillaInput.setText("")
        self.bolillaInput.setObjectName("bolillaInput")
        self.verticalLayout.addWidget(self.bolillaInput)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelOperador.setText(_translate("MainWindow", "Operarador"))
        ...
        self.label_13.setText(_translate("MainWindow", "Dureza"))
        ...
        self.bolillaInput.setPlaceholderText(_translate("MainWindow", "Bolilla"))
        self.label_16.setText(_translate("MainWindow", "Diámetro de la bolilla"))
